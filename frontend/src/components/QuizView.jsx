              ...
              {["A", "B", "C", "D"].map((L) => {
                ...
                return (
                  <button
                    ...
                    className={`flex items-start gap-4 rounded-3xl px-4 py-4 text-left text-sm transition ${
                      selected
                        ? "bg-vscode-accent/15 text-white ring-1 ring-vscode-accent"
                        : "bg-slate-900/90 text-slate-200 hover:bg-slate-900"
                    }`}
                  >
                    <span className="flex shrink-0 h-9 w-9 items-center justify-center rounded-2xl bg-slate-800 font-mono font-semibold text-slate-300">
                      {L}
                    </span>
                    <span className="flex-1 mt-1 leading-snug break-words">
                      {text}
                    </span>
                  </button>
                );
